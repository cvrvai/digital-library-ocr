...
# 3. Launch Web Server
Write-Host "[3/3] Starting Digital Library Web Server on http://127.0.0.1:8080 ..." -ForegroundColor Yellow
Start-Process "http://127.0.0.1:8080"

& $PythonExe -m uvicorn app:app --host 127.0.0.1 --port 8080 --reload
